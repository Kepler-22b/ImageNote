...
var paths = {
    dist: 'public',
    cssSrcArray: [
        'components/core/startup.scss',
        'components/**/*.scss'
    ],
    cssDist: 'public/css/',
    cssDistFileName: 'final.min.css',
    tpls: '../**/*.tpl'
};
...
gulp.task('css', function () {
    ...
    return gulp.src(paths.cssSrcArray)
        ...
        .pipe(remember('css'))
        .pipe(concat(paths.cssDistFileName))
...
gulp.task('watch', function () {
    ...
    gulp.watch(paths.cssSrcArray, ['css'])
        ...
        .on('change', function (filepath) {
            ...
            var fileName = path.basename(filepath.path);
            if (fileName[0] == '_') {
